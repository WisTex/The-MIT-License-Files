...
Plus, if you are ~~lazy~~ efficient, then including these files means you don't have to maintain a giant file of licenses (unless you want to). Just add these to a `licenses` subdirectory and you are fine.
